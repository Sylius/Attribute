...
{
    private SelectAttributeType $type;
    ...
    public function testStorageTypeShouldBeJson(): void
    {
        self::assertSame('json', $this->type->getStorageType());
    }

    public function testTypeShouldBeSelect(): void
    {
